          ...
          <DialogContent className="max-w-[95vw] md:max-w-[600px] dark:bg-card">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                />
                {loadingUpload && (
                  <p className="text-sm">Загрузка обложки...</p>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="date" className="text-xs font-light">
                    Дата начала события
                  </Label>
                  <Input
                    id="date"
                    type="date"
                    value={format(
                      new Date(eventStore.editedEvent.start || 0),
                      "yyyy-MM-dd"
                    )}
                    onChange={(e) => {
                ...
                <div className="space-y-2">
                  <Label htmlFor="time" className="text-xs font-light">
                  ...
                  <div className="text-sm sm:text-base text-foreground w-full break-words">
                    <div className="font-semibold text-base sm:text-lg leading-tight">
                      {capitalizeFirstLetter(
                        format(
                          new Date(
                            eventStore.originalEvent?.start || event.start || 0
                          ),
                          "EEEE, d MMMM",
                          { locale: ru }
                        )
